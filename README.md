...
| `plan-ledger-tasks-yylo` | YYLO CLI + YYLO Ledger CLI (`yy`, `yylo-ledger`) | yes for Ledger planning workflow | `npm install -g @yylo/cli` + `python -m pip install yylo-ledger` |
