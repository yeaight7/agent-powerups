...
1. Stop. Do not continue with detection or extraction.
2. Tell the user `graphifyy` is required and is not currently importable from `python`.
3. Show install options:
